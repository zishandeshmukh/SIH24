...
<body class="bg-opacity-80 bg-gray-900 min-h-screen flex flex-col justify-center items-center">
    ...
    <script>
        ...
        const studentForm = `
            ...
            <p class="text-center text-gray-500 mt-4">Already have an account? <a href="/login" class="text-blue-600 hover:underline">Login</a></p>
        `;
        ...
        const alumniForm = `
            ...
            <p class="text-center text-gray-500 mt-4">Already have an account? <a href="/login" class="text-green-600 hover:underline">Login</a></p>
        `;
        ...
        const collegeForm = `
            ...
            <p class="text-center text-gray-500 mt-4">Already have an account? <a href="/login" class="text-purple-600 hover:underline">Login</a></p>
        `;
